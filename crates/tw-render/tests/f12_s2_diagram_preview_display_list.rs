//! U-F12-S2 — diagram preview PNG appears in the display list image batch.
...
#[test]
fn u_f12_s2_diagram_preview_in_image_batch() {
    ...
    assert!(
        ...
        "diagram with preview should layout as image"
    );
    assert!(
...
#[test]
fn u_f12_s2_diagram_without_preview_keeps_placeholder() {
    let mut doc = tw_model::Document::new();
    doc.sections[0].blocks = vec![Block::ShapeBlock(ShapeBlock {
        id: tw_model::NodeId::new(),
        shape: ShapeData {
